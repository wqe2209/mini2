...
function now(){
    return(
        <section>
        <h1 class="nowTitle">현재 전시</h1>
        <div className='NowImg1'></div>
        <div className="now_wrap">
            <section class="content">
            <div className="container">
            <div className="row">
                <div className="col-4">
                    <p class="NowImg1_Left">Color is life</p>
                </div>
                <div className="col-8">
                    <p class="NowImg1_Title">&#12300;올림피아 자그놀리 : LIFE IS COLOR&#12301;그림전시<br/><br/></p>

<p class="NowImg1_Text">“Life is color”는 올림피아 자그놀리 작가의 한국 첫번째 전시이다.<br/>
...
최고의 브랜드가 ‘픽’한 올림피아 자그놀리의 국내 최초 전시</p>
                ...
                <div className="col-4">
                    <p class="NowImg3_Title">150여점  전시</p>
                    <p class="NowImg3_Text">선명한 라인과 생기 넘치는 색채로 디자인 오브제와 키네틱 조각, 비디오 클립으로 창작하는 아티스트 작품 150여점 전시<br/>
